...
const summaryStats = [
  {
    ...
    changeType: "decrease",
    icon: Banknote,
    description: "Tracked flows (2018, CPI)",
  },
  {
    title: "Annual Need",
    value: "$5.13B",
    ...
    changeType: "decrease",
    icon: TrendingUp,
    description: "World Bank CCDR 2023",
  },
  {
    title: "NDC Cost (2020-2030)",
    value: "$62B",
    change: "87% intl",
    changeType: "increase",
    icon: Building2,
    description: "$6.2B/year required",
  },
  {
    title: "FLLoCA Disbursed",
    value: "$82M",
    change: "47 counties",
    changeType: "increase",
    icon: FileCheck,
    description: "Of $287M total program",
  },
];
...
const financeSources = [
  ...
  {
    name: "World Bank (DPO + FLLoCA + KEWASIP)",
    type: "MULTILATERAL",
    committed: 2023000000,
    disbursed: 1200000000,
    currency: "USD",
    status: "Active",
    color: "blue",
  },
  {
    name: "GEF (All-time grants)",
    type: "MULTILATERAL",
    committed: 437840000,
    disbursed: 350000000,
    currency: "USD",
  ...
  {
    name: "AfDB (Green Finance + Geothermal)",
    type: "BILATERAL",
    committed: 225500000,
    disbursed: 166500000,
    currency: "USD",
  ...
  {
    name: "National Budget (Climate-related)",
    type: "NATIONAL_BUDGET",
    committed: 76000000000,
    disbursed: 62300000000,
    currency: "KES",
    status: "Active",
    color: "teal",
  },
...
const sectorAllocation = [
  { sector: "Energy (incl. Transport)", percentage: 56, amount: 34720000000, color: "emerald" },
  { sector: "LULUCF / Forestry", percentage: 24, amount: 14880000000, color: "green" },
  { sector: "Agriculture", percentage: 11, amount: 6820000000, color: "amber" },
  { sector: "Water & Blue Economy", percentage: 5, amount: 3100000000, color: "blue" },
  { sector: "Waste", percentage: 2, amount: 1240000000, color: "violet" },
  { sector: "Industry (IPPU)", percentage: 2, amount: 1240000000, color: "slate" },
];
