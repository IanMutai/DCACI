...
const policies: Policy[] = [
  { id: 1, name: "National Energy Policy (2018)", sector: "Energy", type: "regulatory", status: "implemented", startDate: "2018-06-15", ghgImpact: 5.2, description: "Comprehensive energy policy framework promoting energy efficiency and renewable energy deployment across all sectors.", linkedTargets: ["30% renewable energy by 2030", "Energy efficiency improvement"], timelineStage: 2 },
  { id: 2, name: "Feed-in Tariff Policy", sector: "Energy", type: "economic", status: "implemented", startDate: "2012-01-01", ghgImpact: 3.8, description: "Guaranteed purchase prices for electricity generated from renewable energy sources including solar, wind, biomass, and geothermal.", linkedTargets: ["Renewable energy generation capacity", "Grid decarbonization"], timelineStage: 3 },
  { id: 3, name: "Forest Conservation & Management Act (2016)", sector: "LULUCF", type: "regulatory", status: "implemented", startDate: "2016-09-01", ghgImpact: 8.1, description: "Legal framework for sustainable management of forests, including community participation and benefit sharing mechanisms.", linkedTargets: ["10% tree cover by 2030", "Forest carbon stock enhancement"], timelineStage: 2 },
  { id: 4, name: "National Climate Change Action Plan (2018-2022)", sector: "Cross-cutting", type: "regulatory", status: "implemented", startDate: "2018-03-01", ghgImpact: null, description: "Kenya's second national climate change action plan providing a framework for implementing climate actions across all sectors.", linkedTargets: ["Overall NDC implementation", "Institutional capacity"], timelineStage: 3 },
  { id: 5, name: "Kenya National Adaptation Plan (2015-2030)", sector: "Adaptation", type: "regulatory", status: "implemented", startDate: "2015-07-01", ghgImpact: null, description: "Long-term adaptation planning addressing climate risks in agriculture, water, health, infrastructure, and ecosystems.", linkedTargets: ["Climate resilience", "Adaptation mainstreaming"], timelineStage: 2 },
  { id: 6, name: "Green Transport Strategy", sector: "Transport", type: "regulatory", status: "adopted", startDate: "2023-11-01", ghgImpact: 1.2, description: "Strategy for transitioning to low-carbon transport including public transit improvements, fuel efficiency standards, and NMT promotion.", linkedTargets: ["Transport emissions reduction", "Modal shift targets"], timelineStage: 1 },
  { id: 7, name: "National Clean Cooking Strategy", sector: "Energy", type: "information", status: "implemented", startDate: "2019-05-01", ghgImpact: 2.4, description: "Promoting transition from traditional biomass to clean cooking solutions including LPG, bioethanol, and improved cookstoves.", linkedTargets: ["Universal clean cooking access", "Household emissions reduction"], timelineStage: 2 },
  { id: 8, name: "Climate-Smart Agriculture Strategy", sector: "Agriculture", type: "voluntary", status: "adopted", startDate: "2023-06-01", ghgImpact: 3.1, description: "Promoting climate-smart agricultural practices to enhance productivity while reducing GHG emissions and building resilience.", linkedTargets: ["Agricultural emissions intensity", "Food security"], timelineStage: 1 },
  { id: 9, name: "Carbon Markets Regulations", sector: "Market", type: "market", status: "planned", startDate: "2025-01-01", ghgImpact: null, description: "Regulatory framework for domestic and international carbon trading under Article 6 of the Paris Agreement.", linkedTargets: ["Carbon market infrastructure", "NDC conditionality"], timelineStage: 0 },
  { id: 10, name: "Electric Mobility Policy", sector: "Transport", type: "economic", status: "planned", startDate: "2025-06-01", ghgImpact: 0.8, description: "Policy framework for promoting electric vehicle adoption including tax incentives, charging infrastructure, and EV manufacturing.", linkedTargets: ["EV adoption targets", "Transport decarbonization"], timelineStage: 0 },
];
