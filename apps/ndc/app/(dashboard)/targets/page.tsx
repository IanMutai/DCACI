...
const targets: NDCTarget[] = [
  {
    ...
    baseValue: "73 MtCO2e",
    targetYear: 2030,
    targetValue: "32% below BAU",
    currentValue: "17.3% below BAU",
    progress: 54,
    status: "on-track",
    unit: "% below BAU",
  ...
  },
  {
    ...
    conditionality: "Unconditional",
    baseYear: 2015,
    baseValue: "70% electricity",
    targetYear: 2030,
    targetValue: "100% electricity",
    currentValue: "92% electricity",
    progress: 73,
    status: "on-track",
    unit: "% of electricity",
  ...
  },
  {
    ...
    conditionality: "Unconditional",
    baseYear: 2015,
    baseValue: "6.9% of land area",
    targetYear: 2030,
    targetValue: "10% of land area",
    currentValue: "8.8% of land area",
    progress: 61,
    status: "on-track",
    unit: "% of land area",
  ...
  },
  {
    ...
    baseValue: "630 MW",
    targetYear: 2030,
    targetValue: "5,000 MW",
    currentValue: "1,020 MW",
    progress: 9,
    status: "off-track",
    unit: "MW",
  ...
  },
  {
    ...
    baseValue: "15% access",
    targetYear: 2028,
    targetValue: "100% access",
    currentValue: "38% access",
    progress: 27,
    status: "off-track",
    unit: "% of households",
  ...
  },
  {
    ...
    name: "Electric Mobility Penetration",
    sector: "Transport",
    sectorIcon: Car,
    type: "Intensity",
    conditionality: "Conditional",
    baseYear: 2020,
    baseValue: "0.1% EV share",
    targetYear: 2030,
    targetValue: "5% EV penetration",
    currentValue: "1.2% EV share",
    progress: 22,
    status: "at-risk",
    unit: "% of new vehicles",
    lastUpdated: "2025-09-30",
  },
  {
    id: "climate-smart-agriculture",
    name: "Climate-Smart Agriculture Adoption",
    sector: "Agriculture",
    sectorIcon: Wheat,
    type: "Intensity",
    conditionality: "Conditional",
    baseYear: 2015,
    baseValue: "5% of farmers",
    targetYear: 2030,
    targetValue: "50% of farmers",
    currentValue: "18% of farmers",
    progress: 29,
    status: "at-risk",
    unit: "% of farmers",
