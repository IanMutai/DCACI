...
const ndcVersions: NDCVersion[] = [
  ...
  { version: "Updated NDC", title: "Kenya's Updated Nationally Determined Contribution", submissionDate: "2020-12-24", unfcccRef: "NDC Registry - Kenya (2020)", status: "submitted", keyTargets: [{ label: "Unconditional Target", value: "7% GHG reduction by 2030 vs BAU (domestic resources)" }, { label: "Conditional Target", value: "32% GHG reduction by 2030 vs BAU (with international support)" }, { label: "Base Year", value: "2015" }, { label: "Target Year", value: "2030" }, { label: "Scope", value: "Economy-wide (7 sectors including LULUCF)" }, { label: "GHG Covered", value: "CO2, CH4, N2O, HFCs" }, { label: "Adaptation Component", value: "Enhanced adaptation priorities across 8 sectors" }], enhancements: ["Overall target of 32% below BAU by 2030 (7% unconditional, 32% with support)", "Clearer distinction between unconditional and conditional components", "Updated base year from 2010 to 2015", "Expanded GHG coverage to include HFCs", "Added LULUCF sector", "Strengthened adaptation component", "Aligned with Long-Term Low Emission Development Strategy"], documents: [{ name: "Kenya_Updated_NDC_2020.pdf", type: "PDF", size: "3.1 MB" }, { name: "Kenya_NDC_Implementation_Plan.pdf", type: "PDF", size: "4.5 MB" }, { name: "Kenya_NDC_Finance_Strategy.pdf", type: "PDF", size: "2.2 MB" }] },
  { version: "2nd NDC", title: "Kenya's Second Nationally Determined Contribution (2031-2035)", submissionDate: "2025-04-30", unfcccRef: "NDC Registry - Kenya (2025)", status: "submitted", keyTargets: [{ label: "Unconditional Target", value: "20% of 35% reduction achieved domestically" }, { label: "Conditional Target", value: "35% GHG reduction by 2035 vs BAU (215 MtCO2e)" }, { label: "Base Year", value: "2020" }, { label: "Target Year", value: "2035" }, { label: "Scope", value: "Economy-wide, all IPCC sectors" }, { label: "GHG Covered", value: "All Kyoto gases" }, { label: "Net-Zero Alignment", value: "Pathway to carbon neutrality by 2050" }], enhancements: ["Extended timeframe to 2035 aligned with global stocktake", "35% reduction target vs BAU of 215 MtCO2e by 2035", "All Kyoto Protocol gases included", "Net-zero 2050 pathway integration", "Strengthened adaptation and loss & damage", "Article 6 carbon market provisions", "Just transition considerations", "Gender-responsive climate action"], documents: [{ name: "Kenya_2nd_NDC_2031_2035.pdf", type: "PDF", size: "5.8 MB" }, { name: "Kenya_2nd_NDC_Technical_Annex.xlsx", type: "Excel", size: "3.2 MB" }] },
];
...
const preparationChecklist = [
  ...
  { id: 5, task: "Finance needs assessment update", status: "complete" as const, dueDate: "2025-01-31" },
  { id: 6, task: "Policy gap analysis", status: "complete" as const, dueDate: "2025-01-31" },
  { id: 7, task: "Draft NDC document", status: "complete" as const, dueDate: "2025-02-28" },
  { id: 8, task: "Public review period", status: "complete" as const, dueDate: "2025-03-31" },
  { id: 9, task: "Cabinet approval", status: "complete" as const, dueDate: "2025-04-15" },
  { id: 10, task: "UNFCCC submission", status: "complete" as const, dueDate: "2025-04-30" },
];
      ...
      <div className="card-elevated">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {[{ param: "Unconditional Target", v1: "30%", v2: "7% (domestic)", v3: "20% of target (domestic)" }, { param: "Conditional Target", v1: "Not specified", v2: "32% (with support)", v3: "35% (with support)" }, { param: "Target Year", v1: "2030", v2: "2030", v3: "2035" }, { param: "Base Year", v1: "2010", v2: "2015", v3: "2015" }, { param: "GHG Coverage", v1: "CO2, CH4, N2O", v2: "CO2, CH4, N2O, HFCs", v3: "All Kyoto gases" }, { param: "Sectors", v1: "6 sectors", v2: "7 sectors (+ LULUCF)", v3: "All IPCC sectors" }, { param: "Adaptation", v1: "Limited", v2: "Enhanced", v3: "Comprehensive + L&D" }, { param: "Net-Zero Alignment", v1: "No", v2: "No", v3: "Yes (2050)" }].map((row) => (
