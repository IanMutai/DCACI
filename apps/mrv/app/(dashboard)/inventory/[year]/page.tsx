...
const yearDataMap: Record<string, YearData> = {
  "2023": {
    ...
    sectors: [
      { code: "1", name: "Energy", icon: <Flame size={16} className="text-orange-600" />, emissions: 44.1, pctOfTotal: 46.3, prevYearChange: 3.0, status: "in_progress" },
      { code: "2", name: "IPPU", icon: <Factory size={16} className="text-blue-600" />, emissions: 3.5, pctOfTotal: 3.7, prevYearChange: 6.1, status: "pending" },
      { code: "3", name: "Agriculture", icon: <Wheat size={16} className="text-green-600" />, emissions: 27.2, pctOfTotal: 28.6, prevYearChange: 2.3, status: "in_progress" },
      { code: "3B", name: "LULUCF", icon: <TreePine size={16} className="text-emerald-600" />, emissions: -13.1, pctOfTotal: 13.8, prevYearChange: -6.5, status: "pending" },
      { code: "4", name: "Waste", icon: <Trash2 size={16} className="text-purple-600" />, emissions: 8.8, pctOfTotal: 9.2, prevYearChange: 4.8, status: "complete" },
    ],
    timeline: [
  ...
  "2022": {
    ...
    gwpValues: "AR5 (IPCC Fifth Assessment Report)",
    sectors: [
      { code: "1", name: "Energy", icon: <Flame size={16} className="text-orange-600" />, emissions: 42.8, pctOfTotal: 46.3, prevYearChange: 2.1, status: "complete" },
      { code: "2", name: "IPPU", icon: <Factory size={16} className="text-blue-600" />, emissions: 3.3, pctOfTotal: 3.6, prevYearChange: 1.8, status: "complete" },
      { code: "3", name: "Agriculture", icon: <Wheat size={16} className="text-green-600" />, emissions: 25.6, pctOfTotal: 27.7, prevYearChange: 0.8, status: "complete" },
      { code: "3B", name: "LULUCF", icon: <TreePine size={16} className="text-emerald-600" />, emissions: -12.3, pctOfTotal: 13.3, prevYearChange: -2.5, status: "complete" },
      { code: "4", name: "Waste", icon: <Trash2 size={16} className="text-purple-600" />, emissions: 8.4, pctOfTotal: 9.1, prevYearChange: 4.2, status: "complete" },
    ],
    timeline: [
