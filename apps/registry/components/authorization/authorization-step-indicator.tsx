...
const steps: Step[] = [
  ...
  { id: 4, label: "Project proponent's contact details" },
  { id: 5, label: "Declaration" },
]

interface AuthorizationStepIndicatorProps {
  currentStep: number
}

export default function AuthorizationStepIndicator({ currentStep }: AuthorizationStepIndicatorProps) {
  return (
